                ...
                <motion.div
                  ...
                  className={`relative flex flex-col rounded-2xl border-2 p-5 transition-shadow bg-surface ${
                    preselectedPlanCode === lifetimePlan.code
                      ? 'border-neutral-900 dark:border-neutral-100 shadow-lg shadow-neutral-900/15 dark:shadow-neutral-100/10'
                      : 'border-neutral-300 dark:border-neutral-700 hover:border-neutral-900 dark:hover:border-neutral-200 hover:shadow-md'
                  }`}
                >
                  <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-neutral-900 dark:bg-neutral-100 px-3 py-0.5 text-[11px] font-bold text-white dark:text-neutral-900 whitespace-nowrap">
                    One-time payment
                  </span>
                  <div className="mb-3">
                  ...
                  <ul className="mb-3 flex-1 space-y-2 text-xs text-ink-muted">
                    <li className="flex items-center gap-2"><Users className="h-3.5 w-3.5 shrink-0" />Unlimited users</li>
                    <li className="flex items-center gap-2"><GitBranch className="h-3.5 w-3.5 shrink-0" />Unlimited branches</li>
                    <li className="flex items-center gap-2"><Monitor className="h-3.5 w-3.5 shrink-0" />Unlimited devices</li>
                  ...
                  <button
                    ...
                    disabled={!!submitting}
                    className="w-full flex items-center justify-center gap-1.5 rounded-xl py-2.5 text-sm font-bold transition-all disabled:opacity-50 bg-neutral-900 hover:bg-neutral-800 text-white dark:bg-neutral-100 dark:hover:bg-white dark:text-neutral-900"
                  >
