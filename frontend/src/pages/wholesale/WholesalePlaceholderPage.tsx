...
export function WholesalePlaceholderPage({ title, description }: { title: string; description: string }) {
  return (
    <div className="space-y-6">
      ...
      <div className="flex min-h-[240px] flex-col items-center justify-center rounded-xl border border-dashed border-line bg-surface p-8 text-center">
        ...
        <p className="mt-3 text-sm text-ink-muted">This wholesale module is coming in a future release.</p>
      </div>
    </div>
  );
}
